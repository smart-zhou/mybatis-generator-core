...
public interface Plugin {
    ...
    boolean clientSelectByParamMethodGenerated(Method method,
                                               Interface interfaze, IntrospectedTable introspectedTable);
    ...
    boolean sqlMapSelectByParamElementGenerated(XmlElement element, IntrospectedTable introspectedTable);
